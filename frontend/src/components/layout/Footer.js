            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  <div className="logo">
                    <a href="index.html"><img src="/images/sdlogo.png" alt="#" style={{width:'150px', height:'50px'}}/></a>
                  </div>
                  <p className="text">Website bán hàng trực tuyến của SD Store, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
